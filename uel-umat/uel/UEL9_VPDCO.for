...
C23456789012345678901234567890123456789012345678901234567890123456789012
C                                                                      C
C  UEL9_VPDCO.for  9-Noded Viscoplasticity Damage Couple Stress Theory C
C  USER ELEMENT SUBROUTINE-COSSERAT PLASTIC MATERIAL BEHAVIOR          C
C                                                                      C
...
C    7-12: BACK STRESS VECTOR                  (6)                     C
C   13-18: TOTAL STRAIN VECTOR                 (6)                     C
C   19-24: ELASTIC STRAIN VECTOR               (6)                     C
C   25-30: PLASTIC STRAIN VECTOR               (6)                     C
C      31: EQUIVALENT PLASTIC STRAIN           (1)                     C
C      32: DAMAGE PARAMETER                    (1)                     C
C      33: HELMHOLTZ FREE ENERGY TERM          (1)                     C
C      34: EQUVALENT STRESS                    (1)                     C
C                                   TOTAL     306 SVARS                C
C                                                                      C
C    REDUCED INTEGRATION PART(4 GAUSS POINTS)                          C
C                                                                      C
C      35: ASYMMETRIC STRESS                   (1)                     C
C      36: RELATIVE ROTATION                   (1)                     C
C                                   TOTAL       8 SVARS                C
C                                   TOTAL     314 SVARS                C
C                                                                      C
C    NODAL VALUES OF ONE STRESS AND STRAIN COMPONENT                   C
C                                                                      C
C     315: STRESS AT GAUSS POINT SPECIFIED                             C
C     316  STRAIN T GAUSS POINT SPECIFIED                              C
C                                                                      C
C                                   TOTAL     316 SVARS                C
C                                                                      C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C                                                                      C
C      1-6: Elastic strain vector                                      C
C     7-12: Plastic strain vector                                      C
C       13: Equivalent plastic strain.                                 C
C    14-19: Back stress vector.                                        C
C       20: Damage Parameter                                           C
C       21: Helmhlotz free energy term                                 C
C       22: Equivalent stress                                          C
C                                                                      C
