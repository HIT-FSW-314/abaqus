...
C23456789012345678901234567890123456789012345678901234567890123456789012
C                                                                      C
C  UEL8_VPDCL.for  8-Noded Element Viscoplasticity with Damage         C
C  USER ELEMENT SUBROUTINE                                             C
C                                                                      C
C  8-NODED ISOPARAMETRIC ELEMENT WITH DAMAGE MECHANICS                 C
...
C     LAST UPDATED OCTOBER 2/2003                                      C
C     USES RETURN MAPPING INTEGRATIONS SCHEME                          C
C                                                                      C
C23456789012345678901234567890123456789012345678901234567890123456789012
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
...
C
     ...
     &    *FLOW(K1)*(ONE-D)
          ...
          STRESS(K1)=FLOW(K1)*(ONE-D)*SYIELD+XBACK(K1)+SHYDRO
        END DO
C
        DO K1=NDI+1,NTENS
          XBACK(K1)=XBACK(K1)+DSQRT(TWO/THREE)*(SYIELDK-SYIELDK0)
     &    *FLOW(K1)*(ONE-D)
          ...
          EELAS(K1)=EELAS(K1)-EPLAS(K1)
          STRESS(K1)=FLOW(K1)*(ONE-D)*SYIELD+XBACK(K1)
        END DO
C
