...
C23456789012345678901234567890123456789012345678901234567890123456789012
C                                                                      C
C  UEL8_ECO.for  8-Noded Couple Stress Elastcity                       C
...
C                                                                      C
C      13: ASYMMETRIC STRESS                   (1)                     C
C      14: RELATIVE ROTATION                   (1)                     C
C                                   TOTAL       8 SVARS                C
C                                SUBTOTAL     116 SVARS                C
C                                                                      C
C    NODAL VALUES OF ONE STRESS AND STRAIN COMPONENT                   C
C                                                                      C
C     117: STRESS AT GAUSS POINT SPECIFIED                             C
C     118  STRAINT GAUSS POINT SPECIFIED                               C
C                                                                      C
C                                   TOTAL     118 SVARS                C
C                                                                      C
C                                                                      C
