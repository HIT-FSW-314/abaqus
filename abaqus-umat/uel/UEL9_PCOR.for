...
C23456789012345678901234567890123456789012345678901234567890123456789012
C                                                                      C
C  UEL9_PCOR.for  9-Noded Plasticity Couple Stress theory              C
C                 Return Mapping Algorithm Linear Isotropic Harden.    C
...
C     253  STRAIN T GAUSS POINT SPECIFIED                              C
C                                                                      C
C                                   TOTAL     253 SVARS                C
C                                                                      C
C                                                                      C
...
C23456789012345678901234567890123456789012345678901234567890123456789012
C                                                                      C
C     UMAT_PCO_R.for    Plasticity Couple Stress Theory                C
C                       Return Mapping Algorithm                       C
C                                                                      C
C     SUBROUTINE UMAT                                                  C
C     PLANE STRAIN ANALYSIS                                            C
C     RATE INDEPENDENT LINAR ISOTROPIC HARDENING PLASTICITY            C
C                                                                      C
C     CREATED BY JUAN GOMEZ                                            C
C     June 19/2004                                                     C
...
C
     ...
     1+(SDEV(2,1)-SDEV(3,1))**2+(SDEV(3,1)-SDEV(1,1))**2
      ...
      END DO
      SMISES=SMISES+THREE*SDEV(5,1)**2+THREE*SDEV(6,1)**2
